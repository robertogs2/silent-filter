...
#ifndef SILENT_ALLOCATOR_HPP
#define SILENT_ALLOCATOR_HPP
...
# endif  
  ...
  struct is_aligned_alloc< silent::aligned_allocator<T,A> > {
    static const bool value = true;
  };

  // Specialization for the aligned_row_allocator
  template<typename T, std::size_t A>
  struct is_aligned_alloc< silent::aligned_row_allocator<T,A> > {
    static const bool value = true;
  };
